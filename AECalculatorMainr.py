from AECalcFormulasr import BasicMath
from AECalcFormulasr import Physics
from AECalcFormulasr import Chemistry
from AECalcFormulasr import Geometry
from AECalcFormulasr import Conversion
...
while True:
    try:
        ...
        if x == 1:
            ...
            if y == 1:
                calc = BasicMath(float(input("Enter Value: ")),
            ...
            if y == 1:
                ...
                if z == 1:
                    calc = Physics(float(input("Enter Value: ")),
                                   float(input("Enter Value: "))
                                   )
                ...
                z = int(input(YELLOW + "Enter Feature: "))
                if z == 1:
                    calc = Chemistry(float(input("Enter Value: ")),
                                     float(input("Enter Value: "))
                                     )
                ...
                z = int(input(YELLOW + "Enter Feature: "))
                if z == 1:
                    calc = Geometry(float(input("Enter Value: ")))
            ...
            if y == 1:
                ...
                z = int(input(YELLOW + "Enter Feature: "))
                if z == 1:
                    calc = Conversion(float(input("Enter Value: ")))
